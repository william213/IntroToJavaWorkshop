...
public class SpeakAndSpell {
	...
	public static void main(String[] args) {
		...
		String e = JOptionPane.showInputDialog("type the word");
		// 3. If the user spelled the word correctly, speak "correct"
		if (e.equals("pneumonoultramicroscopicsilicovolcanoconiosis")) {
			// 4. Otherwise say "wrong"
			speak("you did it");

			// 5. repeat the process for other words
		} else {
			speak("your a failure that's the easiest word in the world" + " ");
		}
	}
